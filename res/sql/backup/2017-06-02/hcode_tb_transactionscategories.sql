...
--
-- Table structure for table `tb_transactionscategories`
--

DROP TABLE IF EXISTS `tb_transactionscategories`;
...
--
-- Dumping data for table `tb_transactionscategories`
--

LOCK TABLES `tb_transactionscategories` WRITE;
/*!40000 ALTER TABLE `tb_transactionscategories` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_transactionscategories` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:15:51
