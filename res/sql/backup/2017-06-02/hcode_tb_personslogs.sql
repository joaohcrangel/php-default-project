...
--
-- Table structure for table `tb_personslogs`
--

DROP TABLE IF EXISTS `tb_personslogs`;
...
--
-- Dumping data for table `tb_personslogs`
--

LOCK TABLES `tb_personslogs` WRITE;
/*!40000 ALTER TABLE `tb_personslogs` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_personslogs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:06:46
