...
--
-- Table structure for table `tb_orderspayers`
--

DROP TABLE IF EXISTS `tb_orderspayers`;
...
--
-- Dumping data for table `tb_orderspayers`
--

LOCK TABLES `tb_orderspayers` WRITE;
/*!40000 ALTER TABLE `tb_orderspayers` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_orderspayers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:14:41
