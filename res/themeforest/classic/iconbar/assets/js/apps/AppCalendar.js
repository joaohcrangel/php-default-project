(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define('/apps/AppCalendar', ['exports', 'Site', 'Config'], factory);
    ...
    global.appsAppCalendar = mod.exports;
  }
      ...
      value: function handleFullcalendar() {
        ...
        var my_options = {
          ...
          windowResize: function windowResize(view) {
            ...
            var options = Object.assign({}, my_options);
        ...
        var _options = void 0;
        var my_options_mobile = Object.assign({}, my_options);
        ...
        $('.calendar-list .calendar-event').each(function () {
          ...
          $this.draggable({
            ...
            helper: function helper() {
              return '<a class="fc-day-grid-event fc-event fc-start fc-end" style="background-color:' + (0, _Config.colors)(color[0], color[1]) + ';border-color:' + (0, _Config.colors)(color[0], color[1]) + '">' + '<div class="fc-content">' + '<span class="fc-title">' + $this.data('title') + '</span>' + '</div>' + '</a>';
            }
          });
        });
      }
