...
--
-- Table structure for table `tb_placesvalues`
--

DROP TABLE IF EXISTS `tb_placesvalues`;
...
--
-- Dumping data for table `tb_placesvalues`
--

LOCK TABLES `tb_placesvalues` WRITE;
/*!40000 ALTER TABLE `tb_placesvalues` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_placesvalues` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:08:47
