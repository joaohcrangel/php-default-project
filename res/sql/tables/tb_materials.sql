CREATE TABLE `tb_materials` (
  ...
  CONSTRAINT `fk_materials_materialsunittypes` FOREIGN KEY (`idmaterialtype`) REFERENCES `tb_materialsunittypes` (`idunitytype`) ON DELETE NO ACTION ON UPDATE NO ACTION
