...
--
-- Table structure for table `tb_menususers`
--

DROP TABLE IF EXISTS `tb_menususers`;
...
--
-- Dumping data for table `tb_menususers`
--

LOCK TABLES `tb_menususers` WRITE;
/*!40000 ALTER TABLE `tb_menususers` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_menususers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:07:01
