...
--
-- Table structure for table `tb_emailsshipments`
--

DROP TABLE IF EXISTS `tb_emailsshipments`;
...
--
-- Dumping data for table `tb_emailsshipments`
--

LOCK TABLES `tb_emailsshipments` WRITE;
/*!40000 ALTER TABLE `tb_emailsshipments` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_emailsshipments` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:10:09
