...
--
-- Table structure for table `tb_productsfiles`
--

DROP TABLE IF EXISTS `tb_productsfiles`;
...
--
-- Dumping data for table `tb_productsfiles`
--

LOCK TABLES `tb_productsfiles` WRITE;
/*!40000 ALTER TABLE `tb_productsfiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_productsfiles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:08:31
