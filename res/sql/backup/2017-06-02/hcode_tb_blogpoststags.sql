...
--
-- Table structure for table `tb_blogpoststags`
--

DROP TABLE IF EXISTS `tb_blogpoststags`;
...
--
-- Dumping data for table `tb_blogpoststags`
--

LOCK TABLES `tb_blogpoststags` WRITE;
/*!40000 ALTER TABLE `tb_blogpoststags` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_blogpoststags` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:13:23
