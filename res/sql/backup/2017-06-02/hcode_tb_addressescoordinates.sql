...
--
-- Table structure for table `tb_addressescoordinates`
--

DROP TABLE IF EXISTS `tb_addressescoordinates`;
...
--
-- Dumping data for table `tb_addressescoordinates`
--

LOCK TABLES `tb_addressescoordinates` WRITE;
/*!40000 ALTER TABLE `tb_addressescoordinates` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_addressescoordinates` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:05:10
