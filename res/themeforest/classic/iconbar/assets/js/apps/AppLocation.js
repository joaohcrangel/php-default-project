(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define("/apps/AppLocation", ["exports", "Site"], factory);
    ...
    global.appsAppLocation = mod.exports;
  }
    ...
    babelHelpers.createClass(Map, [{
      ...
      value: function handleMapHeight() {
        var navbarH = this.$siteNavbar.outerHeight(),
            footerH = this.$siteFooter.outerHeight(),
            mapH = this.window.height() - navbarH - footerH;
      ...
      value: function handleSearch() {
        ...
        $(".search-friends input").on("focus", function () {
          $(this).on("keyup", function () {
            ...
            if (inputName === "") for (var _i = 0; _i < self.friendsInList.length; _i++) {
