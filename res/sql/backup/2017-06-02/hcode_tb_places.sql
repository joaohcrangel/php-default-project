...
DROP TABLE IF EXISTS `tb_places`;
...
LOCK TABLES `tb_places` WRITE;
/*!40000 ALTER TABLE `tb_places` DISABLE KEYS */;
INSERT INTO `tb_places` VALUES (2,NULL,'Hcode Treinamentos',5,NULL,NULL,NULL,'2017-05-11 20:53:08');
/*!40000 ALTER TABLE `tb_places` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`hcode`@`%.%.%.%`*/ /*!50003 TRIGGER tg_places_AFTER_INSERT AFTER INSERT ON tb_places FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`hcode`@`%.%.%.%`*/ /*!50003 TRIGGER tg_places_AFTER_UPDATE AFTER UPDATE ON tb_places FOR EACH ROW
BEGIN
	CALL sp_placesdata_save(NEW.idplace);
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`hcode`@`%.%.%.%`*/ /*!50003 TRIGGER tg_places_BEFORE_DELETE BEFORE DELETE ON tb_places FOR EACH ROW
BEGIN
...
-- Dump completed on 2017-06-02 14:13:42
