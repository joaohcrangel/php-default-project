...
--
-- Table structure for table `tb_ordersproducts`
--

DROP TABLE IF EXISTS `tb_ordersproducts`;
...
--
-- Dumping data for table `tb_ordersproducts`
--

LOCK TABLES `tb_ordersproducts` WRITE;
/*!40000 ALTER TABLE `tb_ordersproducts` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_ordersproducts` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:08:39
