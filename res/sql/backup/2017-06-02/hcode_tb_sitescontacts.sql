...
--
-- Table structure for table `tb_sitescontacts`
--

DROP TABLE IF EXISTS `tb_sitescontacts`;
...
--
-- Dumping data for table `tb_sitescontacts`
--

LOCK TABLES `tb_sitescontacts` WRITE;
/*!40000 ALTER TABLE `tb_sitescontacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_sitescontacts` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:13:29
