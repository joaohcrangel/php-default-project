...
--
-- Table structure for table `tb_personsdevices`
--

DROP TABLE IF EXISTS `tb_personsdevices`;
...
--
-- Dumping data for table `tb_personsdevices`
--

LOCK TABLES `tb_personsdevices` WRITE;
/*!40000 ALTER TABLE `tb_personsdevices` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_personsdevices` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:05:28
