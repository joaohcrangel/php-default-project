...
--
-- Table structure for table `tb_transactionsfiles`
--

DROP TABLE IF EXISTS `tb_transactionsfiles`;
...
--
-- Dumping data for table `tb_transactionsfiles`
--

LOCK TABLES `tb_transactionsfiles` WRITE;
/*!40000 ALTER TABLE `tb_transactionsfiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_transactionsfiles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:08:05
