...
--
-- Table structure for table `tb_orderslogs`
--

DROP TABLE IF EXISTS `tb_orderslogs`;
...
--
-- Dumping data for table `tb_orderslogs`
--

LOCK TABLES `tb_orderslogs` WRITE;
/*!40000 ALTER TABLE `tb_orderslogs` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_orderslogs` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:07:29
