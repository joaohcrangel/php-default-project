...
--
-- Table structure for table `tb_blogpostscategories`
--

DROP TABLE IF EXISTS `tb_blogpostscategories`;
...
--
-- Dumping data for table `tb_blogpostscategories`
--

LOCK TABLES `tb_blogpostscategories` WRITE;
/*!40000 ALTER TABLE `tb_blogpostscategories` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_blogpostscategories` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:11:33
