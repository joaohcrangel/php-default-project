...
--
-- Table structure for table `tb_ordersnegotiations`
--

DROP TABLE IF EXISTS `tb_ordersnegotiations`;
...
--
-- Dumping data for table `tb_ordersnegotiations`
--

LOCK TABLES `tb_ordersnegotiations` WRITE;
/*!40000 ALTER TABLE `tb_ordersnegotiations` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_ordersnegotiations` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:07:35
