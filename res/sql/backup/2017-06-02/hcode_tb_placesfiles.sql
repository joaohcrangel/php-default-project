...
--
-- Table structure for table `tb_placesfiles`
--

DROP TABLE IF EXISTS `tb_placesfiles`;
...
--
-- Dumping data for table `tb_placesfiles`
--

LOCK TABLES `tb_placesfiles` WRITE;
/*!40000 ALTER TABLE `tb_placesfiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_placesfiles` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-06-02 14:15:41
